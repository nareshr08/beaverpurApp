...
public class SinglesKOServlet extends HttpServlet {
	...
	private static final Logger log = Logger.getLogger(SinglesKOServlet.class.getName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ListFeed queryResults = SpreadSheetUtilites.querySpreadSheetForListFeed(Constants.SINGLES_TOURNAMENT_FILE, Constants.WorkSheetIndexes.KOR64, koRound, Constants.TournamentType.SINGLES);
	...
	/*protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CellFeed cellFeed = SpreadSheetUtilites.querySpreadSheetForCellFeed(Constants.SINGLES_TOURNAMENT_FILE,queryString,Constants.WorkSheetIndexes.KOROUND, Constants.TournamentType.SINGLES);
		...
		request.getRequestDispatcher("/jsp/singles/koMajorLeagueDetails.jsp").forward(request, response);
	} */
}
