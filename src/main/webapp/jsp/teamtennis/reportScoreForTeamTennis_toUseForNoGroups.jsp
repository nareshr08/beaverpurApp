...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#team1').change(function (event){
			...
			$.get('/reportScoreForTeamTennis',{query:'getTeam2List',selectedTeam1:$team1},function(responseJson) {
		        var $select = $('#team2');                           
...
<body>
	<div>
		<div data-role="page" data-content-theme="a" id="reportScoresForDoubles" data-title="Report scores for TeamTennis 2014">
			...
			<div data-role="content">
				<form action="/reportScoreForTeamTennis" method="POST" id="reportScoreForm">
					...
					<div id="setScores">
						...
						<div class="ui-grid-solo">
							<div class="ui-block-a"><button type="v" data-theme="b">Singles (S2) Info</button></div>
						</div>
						<fieldset class="ui-grid-b">
						...
						<fieldset class="ui-grid-b">
						    ...
						    <div class="ui-block-b">
						    	<select name="singles2Team1Player" id="singles2Team1Player" class="team1Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-c">
						...
						<fieldset class="ui-grid-b">
						    <div class="ui-block-a"><label for="singles2TeamName" class="team2Name required"></label></div>
						    <div class="ui-block-b">
						    	<select name="singles2Team2Player" id="singles2Team2Player" class="team2Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-c">
						...
						<div class="ui-grid-solo">
							<div class="ui-block-a"><button type="v" data-theme="b">Doubles (D2) Info</button></div>
						</div>
						<fieldset class="ui-grid-c">
							<div class="ui-block-a"><label for="doubles2TeamName">Team</label></div>
							<div class="ui-block-b"><label for="doubles2PlayerName">Player1 Name</label></div>
							<div class="ui-block-c"><label for="doubles2PlayerName">Player2 Name</label></div>
							<div class="ui-block-d"><label for="doubles2SetScore">SetScore</label></div>
						</fieldset>
						<fieldset class="ui-grid-c">
						    <div class="ui-block-a"><label for="doubles2TeamName" class="team1Name"></label></div>
						    <div class="ui-block-b">
						    	<select name="doubles2Team1Player1" id="doubles2Team1Player1" class="team1Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-c">
						    	<select name="doubles2Team1Player2" id="doubles2Team1Player2" class="team1Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-d">
						    	<select name="doubles2Team1Score" id="doubles2Team1Score">
									<c:forEach var="counter" begin="0" end="9">
										<option value="${9-counter}" ${counter=='1'? 'selected="selected"' : ''}>${9-counter}</option>
									</c:forEach>
								</select>
						...
						<fieldset class="ui-grid-c">
						    <div class="ui-block-a"><label for="doubles2TeamName" class="team2Name"></label></div>
						    <div class="ui-block-b">
						    	<select name="doubles2Team2Player1" id="doubles2Team2Player1" class="team2Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-c">
						    	<select name="doubles2Team2Player2" id="doubles2Team2Player2" class="team2Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-d">
						    	<select name="doubles2Team2Score" id="doubles2Team2Score">
									<c:forEach var="counter" begin="0" end="9">
										<option value="${counter}">${counter}</option>
									</c:forEach>
								</select>
						...
						<div class="ui-grid-solo">
							<div class="ui-block-a"><button type="v" data-theme="b">Doubles (D3) Info</button></div>
						</div>
						<fieldset class="ui-grid-c">
							<div class="ui-block-a"><label for="doubles3TeamName">Team</label></div>
							<div class="ui-block-b"><label for="doubles3PlayerName">Player1 Name</label></div>
							<div class="ui-block-c"><label for="doubles3PlayerName">Player2 Name</label></div>
							<div class="ui-block-d"><label for="doubles3SetScore">SetScore</label></div>
						</fieldset>
						<fieldset class="ui-grid-c">
						    <div class="ui-block-a"><label for="doubles3TeamName" class="team1Name"></label></div>
						    <div class="ui-block-b">
						    	<select name="doubles3Team1Player1" id="doubles3Team1Player1" class="team1Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-c">
						    	<select name="doubles3Team1Player2" id="doubles3Team1Player2" class="team1Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-d">
						    	<select name="doubles3Team1Score" id="doubles3Team1Score">
									<c:forEach var="counter" begin="0" end="9">
										<option value="${9-counter}" ${counter=='1'? 'selected="selected"' : ''}>${9-counter}</option>
									</c:forEach>
								</select>
						...
						<fieldset class="ui-grid-c">
						    <div class="ui-block-a"><label for="doubles3TeamName" class="team2Name"></label></div>
						    <div class="ui-block-b">
						    	<select name="doubles3Team2Player1" id="doubles3Team2Player1" class="team2Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-c">
						    	<select name="doubles3Team2Player2" id="doubles3Team2Player2" class="team2Players required">
									<option value="NA"></option>
								</select>
							</div>
						    <div class="ui-block-d">
						    	<select name="doubles3Team2Score" id="doubles3Team2Score">
									<c:forEach var="counter" begin="0" end="9">
										<option value="${counter}">${counter}</option>
									</c:forEach>
								</select>
