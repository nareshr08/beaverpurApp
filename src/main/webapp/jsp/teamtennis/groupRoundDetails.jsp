	...
	<div>
		<div data-role="page" data-content-theme="a" id="teamTennisGroupRoundInfo" data-title="Group Round info for Team Tennis 2018">
				...
				<table data-role="table" id="my-table" data-mode="reflow" class="ui-responsive table-stroke table-stripe">
	  				<tbody>
						<c:forEach var="teamsGroup" items="${teamsList}">
							<span style="text-align:left;color:green;font-weight:bold;">Total Teams: ${fn:length(teamsGroup.value)}</span><br/>
							<table data-role="table" id="my-table" data-mode="reflow" class="ui-responsive table-stroke table-stripe">
								<thead>
						    		<tr>
							      	<!-- <th>Cans</th>-->
			...
			<div data-role="footer">
				<span style="text-align:left;font-style:italic;font-size:10px;">For more details please visit <a href="https://sites.google.com/site/beaverpuropentennis/home/season-2018/team-tennis-tournament/teams">Desktop version</a></span>
			</div>
		</div>
	</div>
</body>
