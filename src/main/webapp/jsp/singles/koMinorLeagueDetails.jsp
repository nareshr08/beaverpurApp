...
<html>
<head>
	<title>KO Minor Details for Singles</title>
	<meta charset="utf-8">
	...
	<div>
		<div data-role="page" data-content-theme="a" id="KORoundInfo" data-title="KO Round info for Singles 2018">
			...
			<div data-role="content">
				...
				<form action="/koMinorForSingles" method="POST">
				...
				%>
				<div id="koRoundTable" style="width:100%;">
					<table>
						<tbody>
			...
			<div data-role="footer">
				<span style="text-align:left;font-style:italic;font-size:10px;">For more details please visit <a href="https://sites.google.com/site/beaverpuropentennis/home/season-2018/singles-tournament/minor-ko">Desktop version</a></span>
			</div>
		</div>
	</div>
</body>
