	...
	$(document).ready(function() {
		...
		$('#koRound').change(function(event) {
	        ...
	        var $koType = $("select#koType").val();
		 	$.get('/reportScoreForKO',{koType:$koType,koRound:$koRound},function(responseJson) {
...
<body>
	<div>
		<div data-role="page" data-content-theme="a" id="reportScoresForKO" data-title="Report scores for KO Singles 2014">
