...
<body>
	<div>
		<div data-role="page" data-content-theme="a" id="KORoundInfo" data-title="KO Round info for Singles 2019">
			...
			<div data-role="content">
				<c:choose>
					<c:when test="${selectedRound == 'R64'}">
						<span style="color:red;font-weight:bold;">Round 64 game should be played between 05/20-05/22</span>
					</c:when>
					<c:when test="${selectedRound == 'R32'}">
						<span style="color:red;font-weight:bold;">Round 32 game should be played between 05/23-05/28</span>
					</c:when>
					<c:when test="${selectedRound == 'R16'}">
						<span style="color:red;font-weight:bold;">Pre-Quarter finals game should be played between 05/29-05/31</span>
					</c:when>
					<c:when test="${selectedRound == 'R8'}">
						<span style="color:red;font-weight:bold;">Quarter finals to be played between 06/01-06/03</span>
					</c:when>
					<c:when test="${selectedRound == 'R4'}">
						<span style="color:red;font-weight:bold;">Semifinals to be played between 06/04-06/06</span>
					</c:when>
					<c:otherwise>
