...
<body>
	<div>
		<div data-role="page" data-content-theme="a" id="KORoundInfo" data-title="KO Round info for Doubles 2019">
			...
			<div data-role="content">
				<c:choose>
					<c:when test="${selectedRound == 'R32'}">
						<span style="color:red;font-weight:bold;">Round 32 game should be played between 07/15-07/17</span>
					</c:when>
					<c:when test="${selectedRound == 'R16'}">
						<span style="color:red;font-weight:bold;">Pre-Quarter finals game should be played between 07/18-07/20</span>
					</c:when>
					<c:when test="${selectedRound == 'R8'}">
						<span style="color:red;font-weight:bold;">Quarter finals to be played between 07/21-07/23</span>
					</c:when>
					<c:when test="${selectedRound == 'R4'}">
						<span style="color:red;font-weight:bold;">Semifinals to be played between 07/24-07/25</span>
					</c:when>
					<c:otherwise>
						<span style="color:red;font-weight:bold;">Finals to be played on 07/28</span>
					</c:otherwise>
				</c:choose>
